...
const ProfileModal = ({ onClose }) => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      if (response) {
        console.log("Fetched stockkeeper user data:", response); // Debug log
  ...
  const roleColor = () => {
    switch (Number(userData?.privileges)) { // Ensure privileges is treated as a number
  ...
  console.log("Current stockkeeper privileges:", userData?.privileges, "type:", typeof userData?.privileges);
  console.log("Stockkeeper role name:", getRoleName(userData?.privileges));
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-0 w-[90%] max-w-3xl max-h-[90vh] overflow-hidden shadow-2xl relative">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 p-8 flex items-center space-x-6">
          <div className="w-24 h-24 rounded-full bg-white flex items-center justify-center text-blue-700 text-4xl font-bold shadow-lg ring-4 ring-white">
              ...
              <form onSubmit={handlePasswordChange} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                    required
                  />
                </div>
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700 text-black py-2 px-4 rounded-lg transition-colors flex items-center justify-center"
                  >
                    {isSubmitting ? (
                      <>
                        <div className="animate-spin rounded-full h-4 w-4 border-2 border-blue-200 border-t-transparent mr-2"></div>
                        Processing...
                      </>
                    ) : (
                      'Change Password'
