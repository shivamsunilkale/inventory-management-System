...
const SellOrderForm = ({ onClose, onOrderComplete }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Show success alert
      alert('Sell order created successfully! Waiting for inventory manager approval.');
        ...
        <form onSubmit={handleSubmit} className="space-y-6 h-full flex flex-col">
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            <p className="text-sm text-blue-600">
              ...
              Orders require approval from an inventory manager before they affect inventory levels.
            </p>
          </div>
