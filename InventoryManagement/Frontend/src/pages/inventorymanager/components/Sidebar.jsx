...
const Sidebar = ({ isOpen, onProfileClick }) => {
  ...
  const menuItems = [
    { title: 'Dashboard', path: '/inventorymanager/dashboard', icon: 'chart-pie' },
    { title: 'Inventory', path: '/inventorymanager/inventory', icon: 'box' },
    { title: 'Stock Allocation', path: '/inventorymanager/stock-allocation', icon: 'tasks' },
    { title: 'Stock Movements', path: '/inventorymanager/stock-movements', icon: 'exchange-alt' },
    { title: 'Low Stock', path: '/inventorymanager/low-stock', icon: 'exclamation-triangle' },
    { title: 'Reports', path: '/inventorymanager/reports', icon: 'file-alt' },
  ];
